...
""" + Style.RESET_ALL)
    ...
    print(
        ...
        f"{Fore.LIGHTBLUE_EX}Geliştirici: {Style.RESET_ALL} 5Yusuf-bot"
        f"{Fore.LIGHTRED_EX}Güncel Sürüm:{Style.RESET_ALL} ZynaxSMS 1.7"
    )
    ...
    if menu == 1:
        ...
        if tel_no == "":
            ...
            try:
                ...
                system("cls||clear")
                print(Fore.LIGHTRED_EX + "GERİZEKALI MAL.")
                sleep(3)
                continue
        else:
            try:
